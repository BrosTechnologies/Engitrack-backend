            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    BEGIN TRY
                        ...
                        BEGIN
                            DECLARE @CurrentStockStr NVARCHAR(50) = CAST(@CurrentStock AS NVARCHAR(50));
                            DECLARE @QuantityStr NVARCHAR(50) = CAST(@Quantity AS NVARCHAR(50));
                            DECLARE @ErrorMsg NVARCHAR(200) = 'Insufficient stock. Current: ' + @CurrentStockStr + ', Requested: ' + @QuantityStr;
